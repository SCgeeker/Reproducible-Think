...
這張圖的來源是彙整於[rpp_data.csv](https://osf.io/fgjvw/)的資料，為了讓讀者了解如何重製，這份文件以Rmarkdown撰寫，再製原圖於下方，並將圖中的標示文字改為中文。讀者可以[點此](01.Rmd)檢視產生下圖的R程式碼，我在程式碼中加入的中文註解，是能完整重製這張圖要做的準備。
