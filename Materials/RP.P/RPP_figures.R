...
# If "C-3PR.R" was downloaded, skip this line
# download.file('https://raw.githubusercontent.com/FredHasselman/toolboxR/master/C-3PR.R', destfile = "C-3PR.R")

source("C-3PR.R")  # replace \u2717 and \u03C1
...
#RPPdata <- get.OSFfile(code='https://osf.io/fgjvw/',dfCln=T)$df  # assign to the old data set

# RPPdata <- get.OSFfile(code='https://osf.io/yt3gq/',dfCln=T)$df  ## update CSV remain the bad common at line 94
